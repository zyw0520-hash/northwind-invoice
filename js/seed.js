...
export async function seedIfEmpty() {
  ...
  const dLuening = { id: uid(), type: '送货单', supplierId: s.luening.id, docNumber: '02620863', docDate: '2026-08-17', netAmount: 1187.50, taxRate: 0.19, taxAmount: 225.63, grossAmount: 1413.13, dueDate: null, payStatus: '待确认', summary: '欧标托盘50个+框架100个', costCenter: '', archiveNote: 'LUENING251P_001650.pdf', createdAt: now, updatedAt: now };

  const documents = [
    // 1 Raiffeisen 柴油配送
    { id: uid(), type: '发票', supplierId: s.raif.id, docNumber: '674675', docDate: '2026-08-28', netAmount: 1045.17, taxRate: 0.19, taxAmount: 198.58, grossAmount: 1243.75, dueDate: '2026-09-07', payStatus: '未付', payDate: null, payMethod: '', counterpartyIban: '', summary: 'Diesel 553L 配送', costCenter: '', archiveNote: 'Raiffeisen 674675 vom 28.08.2026.PDF', relatedDeliveryId: null, relatedLeadId: null, note: '采购单 67811', createdAt: now, updatedAt: now },
    // 2 Würth 扭力扳手（挂送货单）
    { id: uid(), type: '发票', supplierId: s.wuerth.id, docNumber: '6088047408', docDate: '2026-08-18', netAmount: 297.14, taxRate: 0.19, taxAmount: 54.77, grossAmount: 343.01, dueDate: '2026-09-07', payStatus: '未付', payDate: null, payMethod: '银行转账', counterpartyIban: 'DE33 6005 0101 0002 0430 58', summary: '扭力扳手套装+运费', costCenter: '', archiveNote: 'Wuerth_Rechnung_6088047408_18_08_2026.PDF', relatedDeliveryId: dWuerthOld.id, relatedLeadId: null, note: '采购单 2276623193', createdAt: now, updatedAt: now },
    // 3 Raiffeisen 维修（待 Alex 确认）
    { id: uid(), type: '发票', supplierId: s.raif.id, docNumber: '674682', docDate: '2026-08-29', netAmount: 3301.00, taxRate: 0.19, taxAmount: 627.19, grossAmount: 3928.19, dueDate: null, payStatus: '待确认', payDate: null, payMethod: '', counterpartyIban: '', summary: '维修/轮胎更换等', costCenter: '', archiveNote: 'Raiffeisen 674682 vom 29.08.2026.PDF', relatedDeliveryId: null, relatedLeadId: null, note: '等Alex确认', createdAt: now, updatedAt: now },
    dLuening,
    // 5 Uwe Kloska 发票（挂送货单）
    { id: uid(), type: '发票', supplierId: s.kloska.id, docNumber: 'R22615092', docDate: '2026-08-25', netAmount: 702.88, taxRate: 0.19, taxAmount: 133.55, grossAmount: 836.43, dueDate: null, payStatus: '待确认', payDate: null, payMethod: '', counterpartyIban: '', summary: '管道刷等工具耗材', costCenter: '', archiveNote: 'R22615092.pdf', relatedDeliveryId: dKloska.id, relatedLeadId: null, note: '等Alex确认', createdAt: now, updatedAt: now },
    // 6 KHT 工业服务
    { id: uid(), type: '发票', supplierId: s.kht.id, docNumber: 'RE26/0565-HB', docDate: '2026-08-31', netAmount: 9075.00, taxRate: 0.19, taxAmount: 1724.25, grossAmount: 10799.25, dueDate: '2026-09-09', payStatus: '待确认', payDate: null, payMethod: '银行转账', counterpartyIban: 'DE68 2919 0024 0225 6835 00', summary: '工业服务/项目', costCenter: '', archiveNote: 'Rechnung RE26 0565-HB.PDF', relatedDeliveryId: null, relatedLeadId: null, note: '等Alex确认', createdAt: now, updatedAt: now },
    // 7 HZA 关税（已逾期示范）
    { id: uid(), type: '关税通知', supplierId: s.hza.id, docNumber: 'ATS-1111-M0028Y', docDate: '2026-08-13', netAmount: 2302.77, taxRate: null, taxAmount: 23.00, grossAmount: 2325.77, dueDate: '2026-08-27', payStatus: '催缴中', payDate: null, payMethod: '银行转账', counterpartyIban: 'DE69 2000 0000 0020 0010 21', summary: '关税+逾期费', costCenter: '', archiveNote: '关税催缴.pdf', relatedDeliveryId: null, relatedLeadId: null, note: '关税催缴', createdAt: now, updatedAt: now },
    // 8 交通罚单
    { id: uid(), type: '罚单', supplierId: s.cux.id, docNumber: '32.4-662603808', docDate: '2026-08-19', netAmount: 180.00, taxRate: null, taxAmount: 28.50, grossAmount: 208.50, dueDate: null, payStatus: '未付', payDate: null, payMethod: '银行转账', counterpartyIban: 'DE79 292500000155000551', summary: '超速罚款 26km/h', costCenter: '', archiveNote: '朱一未超速罚单.pdf', relatedDeliveryId: null, relatedLeadId: null, note: '朱一未超速', createdAt: now, updatedAt: now },
    // 9 Sixt 租车（已付）
    { id: uid(), type: '租车费', supplierId: s.sixt.id, docNumber: '1001020003349636', docDate: '2026-08-18', netAmount: null, taxRate: null, taxAmount: null, grossAmount: null, dueDate: null, payStatus: '已付', payDate: '2026-08-18', payMethod: '信用卡', counterpartyIban: '', summary: '租车费用', costCenter: '', archiveNote: '', relatedDeliveryId: null, relatedLeadId: null, note: '需换公司抬头', createdAt: now, updatedAt: now },
